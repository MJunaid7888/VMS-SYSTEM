...
export default function VisitorCheckIn() {
  ...
  const handleCheckIn = async () => {
    ...
    try {
      ...
      setSuccess(
        "Check-in successful! Generating your digital visitor badge..."
      );
  ...
  return (
    <div className="min-h-screen px-4 py-6 bg-gradient-to-br from-white via-indigo-100 to-purple-100">
      {/* Navbar */}
      <nav className="relative z-20 flex flex-col items-center justify-between mb-8 md:flex-row">
        <Link href="/" className="text-2xl font-bold text-blue-800 md:text-3xl">
          FV VMS
        </Link>
      </nav>

      <div className="w-full max-w-2xl p-6 mx-auto bg-white shadow-lg rounded-3xl md:p-10">
        ...
        {isLoading ? (
          ...
          <div className="px-4 py-3 mb-4 text-green-700 bg-green-100 border border-green-400 rounded-lg">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="mt-1 text-sm">
                  Redirecting to your digital badge...
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="p-6 mb-6 rounded-lg bg-blue-50">
              ...
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="font-medium">
                    {new Date(visitor.visitStartDate).toLocaleDateString()}-
                    {new Date(visitor.visitEndDate).toLocaleDateString()}
                  </p>
                </div>
                <div>
            ...
            {visitor.status === "approved" ? (
              <div className="flex justify-end">
                <button
                  ...
                  disabled={checkingIn}
                  className="px-6 py-3 font-semibold text-white bg-blue-900 rounded-full hover:bg-blue-800 disabled:bg-blue-300"
                >
              ...
              <div className="px-4 py-3 text-gray-700 bg-gray-100 border border-gray-400 rounded">
