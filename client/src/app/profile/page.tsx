...
export default function ProfilePage() {
  ...
  return (
    <div>
      <AppBar />
      <div className="w-full p-6 mx-auto mt-3 overflow-hidden md:max-w-4xl md:mt-8">
        ...
        <Card className="p-6">
          ...
          <div className="mb-4" onChange={handleAvatarChange}>
            <Button className="mt-1 text-xs text-white">
        ...
        {/* Danger Zone */}
        <Card className="p-6 mt-6 border border-red-500">
