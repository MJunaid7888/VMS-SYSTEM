  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        try {
          const trainingStatus = await trainingAPI.getTrainingStatus(
            visitorId,
            token
          );
          ...
          if (
            Array.isArray(trainingStatus) &&
            trainingStatus.length > 0 &&
            trainingStatus.every((completion: any) => completion.passed)
          ) {
  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      ...
      try {
        ...
        const hasPassed =
          calculatedScore >= (currentTraining.requiredScore || 70);
  ...
  if (error) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div className="w-full max-w-2xl p-8 bg-white shadow-2xl rounded-xl">
          <div className="flex items-center justify-between mb-6">
            <h2 className="flex items-center text-2xl font-bold text-red-900">
              <AlertCircle className="w-6 h-6 mr-2 text-red-700" />
              Error
            </h2>
            <button
              onClick={onClose}
          ...
          <div className="p-4 mb-6 text-red-700 border-l-4 border-red-500 rounded-md bg-red-50">
        ...
        <div className="w-full max-w-2xl p-8 bg-white shadow-2xl rounded-xl">
          ...
          <div className="py-8 text-center">
            ...
            <p className="mb-6 text-gray-600">
              There are currently no training modules available for you to
              complete.
            </p>
            <button
              onClick={onClose}
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-lg bg-blue-50">
              <h3 className="mb-2 text-xl font-semibold text-blue-900">
                Welcome to {currentTraining.title}
              </h3>
              ...
              <div className="flex items-start">
                ...
                <p className="text-sm text-blue-700">
                  This training will take approximately 5-10 minutes to
                  complete. You will need to score at least{" "}
                  {currentTraining.requiredScore}% on the quiz to pass.
                </p>
              </div>
            </div>
        ...
        {currentStep === "content" && (
          <div className="space-y-6">
            <div
              ...
              dangerouslySetInnerHTML={{ __html: currentTraining.content }}
            ></div>
            ...
            <div className="flex justify-end mt-6 space-x-3">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-2 text-base font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
              >
                Take Quiz
                <ChevronRight className="w-5 h-5 ml-2" />
              </button>
                ...
                {currentTraining.questions?.[
                  ...
                  >
                    ...
                    <label
                      ...
                      className="flex-grow block text-gray-700 cursor-pointer"
                    >
                      {option}
                    </label>
                  </div>
              ...
              <div className="flex justify-between mt-6">
                ...
                <div className="flex space-x-3">
                  ...
                  >
                    {currentTraining?.questions &&
                    currentQuestionIndex <
                      currentTraining.questions.length - 1 ? (
                      <>
                        Next
                        <ChevronRight className="w-5 h-5 ml-2" />
                      </>
            ...
            {passed ? (
              <div className="p-6 text-center border border-green-200 rounded-lg bg-green-50">
                ...
                <p className="mb-4 text-green-700">
                  You passed the training with a score of {score}%.
                </p>
                <p className="text-green-600">
                  You have successfully completed the {currentTraining.title}.
                </p>
              </div>
            ) : (
              <div className="p-6 text-center border border-red-200 rounded-lg bg-red-50">
                ...
                <p className="mb-4 text-red-700">
                  Your score: {score}%. Required:{" "}
                  {currentTraining.requiredScore}%.
                </p>
              ...
              {!passed && (
                <button
                  onClick={() => {
                    ...
                    setSelectedAnswers(
                      Array(currentTraining.questions?.length).fill(-1)
                    );
                    setScore(0);
                    setPassed(null);
                    setTimeSpent(0);
