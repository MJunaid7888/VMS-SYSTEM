...
export default function VisitorsPage() {
  ...
  return (
    <div className="p-4">
      <h1 className="mb-4 text-2xl font-bold">All Visit History</h1>
      ...
      {loading ? (
        ...
        <div className="flex flex-col gap-4 md:gap-8">
          {/* Visitors Table */}
          <h2 className="mt-4 font-semibold text-gray-800 md:mt-6 md:text-xl">
            Visitors History
          </h2>
          ...
          <div className="overflow-x-auto">
            <table
              className="min-w-full text-sm border divide-y divide-gray-200 rounded shadow"
                  ...
                  <tr key={entry._id} className="border-t">
                    ...
                    <td className="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                      ...
                      entry.hazards.length > 0 ? (
                        ...
                        <span className="italic text-gray-400">No hazards</span>
                      )}
                    </td>
