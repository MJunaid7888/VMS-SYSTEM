        ...
        <div className="p-4 mx-auto space-y-6 bg-white rounded-xl shadow-md mt-2 sm:mt-6 lg:mt-8 xl:mt-10">
          ...
          <form onSubmit={onSubmit}>
            ...
            <p className="text-sm sm:text-base text-gray-600 mb-2 sm:mb-4">
              Please fill in your details to register for a visit. Fields marked
              with * are required.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <Select
                value={form.visitorCategory || "contractor"}
                onValueChange={(value) =>
              ...
              {settings.visitorPhotoRequired && (
                <div>
                  <h2 className="text-sm md:text-base text-gray-700 font-semibold">
                    Upload Profile Picture
                  </h2>
                  <div
                    className={`w-[80%] md:w-2/3 lg:w-4/4 h-fit border-2 border-gray-300 p-2 bg-white rounded-3xl my-4 mx-auto ${
                      form.pics ? "p-1" : "p-10"
                    } `}
                      ...
                      {form.pics ? (
                        ...
                        <>
                          {uploadLoading ? (
                            ...
                            <div className="flex items-center justify-center center gap-2 md:gap-4">
                              <div className="p-2 md:p-3 bg-gray-200 rounded-full">
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-4 sm:p-6 mb-4 sm:mb-6 shadow-sm mt-4 sm:mt-6">
              ...
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                >
                  ...
                  and acknowledge that my personal information will be processed
