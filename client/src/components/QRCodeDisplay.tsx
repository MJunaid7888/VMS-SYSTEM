        ...
        try {
          ...
          if (data && typeof data === "object") {
            ...
            if ("qrCodeUrl" in data && typeof data.qrCodeUrl === "string") {
              ...
              if (
                responseData &&
                "qrCode" in responseData &&
                typeof responseData.qrCode === "string"
              ) {
      ...
      if (svgElement) {
        ...
        img.onload = () => {
          ...
          try {
            ...
            setError(
              "Failed to create download link. Try again or take a screenshot."
            );
          }
        };
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="bg-blue-50 p-4 rounded-lg mb-5 w-full">
              ...
              <p className="text-sm text-blue-700">
                Present this QR code at the reception desk or security
                checkpoint for scanning. This code is valid for your scheduled
                visit and contains your visitor information.
              </p>
            </div>
