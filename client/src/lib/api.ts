...
export const authAPI = {
  ...
  resetPassword: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/auth/reset-password`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  changePassword: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/auth/change-password`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
...
export const visitorAPI = {
  ...
  checkInVisitor: async (
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/visitors/${visitorId}/check-in`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  checkOutVisitor: async (
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/visitors/${visitorId}/check-out`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getVisitorHistory: async (
    ...
    try {
      // Use the correct endpoint from backend routes
      const response = await fetch(
        `${API_BASE_URL}/visitors/visits/${visitorId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  searchVisitorsByEmail: async (
    ...
    try {
      ...
      try {
        ...
        const adminSearchUrl = `${API_BASE_URL}/admin/users?search=${encodeURIComponent(
          email
        )}`;
        ...
        if (adminResponse.ok) {
          ...
          if (visitorsResponse.ok) {
            ...
            const filteredVisitors = visitors.filter(
              (visitor) =>
                visitor.email &&
                visitor.email.toLowerCase() === email.toLowerCase()
            );
      ...
      if (!hostResponse.ok) {
        throw new Error(
          `Failed to fetch visitors: ${hostResponse.status} ${hostResponse.statusText}`
        );
      }
      ...
      // Filter visitors by email (case-insensitive)
      const filteredHostVisitors = hostVisitors.filter(
        (visitor) =>
      ...
      if (error instanceof Error) {
        ...
        throw new Error(
          "Failed to search for visitors. Please try again later."
        );
      }
    }
  },
  ...
  approveVisitor: async (
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/visitors/${visitorId}/approve`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
...
export const accessControlAPI = {
  validateQrCode: async (qrData: string, token: string) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/access-control/validate-qr`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  generateQrCode: async (visitorId: string, token: string) => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/access-control/qr/${visitorId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
...
export const notificationAPI = {
  ...
  sendVisitorNotification: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/notifications/visitor`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  sendHostNotification: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/notifications/host`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  getNotificationHistory: async (token: string): Promise<Notification[]> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/notifications/history`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getNotificationSettings: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/notifications/settings`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
...
export const documentAPI = {
  ...
  getVisitorDocuments: async (
    visitorId: string,
    token: string
  ): Promise<Document[]> => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/documents/visitor/${visitorId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
...
export const siteAPI = {
  ...
  deleteDepartment: async (
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/sites/departments/${departmentId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  createMeetingLocation: async (
    locationData: { name: string; description?: string; capacity?: number },
    token: string
    ...
    try {
      const response = await fetch(`${API_BASE_URL}/sites/meeting-locations`, {
        ...
        body: JSON.stringify({
          ...locationData,
          capacity: locationData.capacity || 10,
        }),
      });
  ...
  deleteMeetingLocation: async (
    locationId: string,
    token: string
  ): Promise<{ message: string }> => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/sites/meeting-locations/${locationId}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
...
export const employeeAPI = {
  getEmployees: async (token: string): Promise<Employee[]> => {
    try {
      ...
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/users?role=host`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      try {
        ...
        try {
          console.warn(
            "Admin users endpoint failed, trying regular users endpoint"
          );
          const usersResponse = await fetch(
            `${NEXT_PUBLIC_API_BASE_URL}/admin/users`,
            {
              method: "GET",
              headers: {
                Authorization: `Bearer ${token}`,
          ...
          try {
            const profileResponse = await fetch(
              `${NEXT_PUBLIC_API_BASE_URL}/auth/profile`,
              {
                method: "GET",
                headers: {
                  Authorization: `Bearer ${token}`,
            ...
            console.warn(
              "All API attempts failed, falling back to mock employee data"
            );
          }
        }
      }
      ...
      throw new Error(
        "Failed to fetch employees. Please check your connection and try again."
      );
    } catch (error) {
  ...
  getEmployee: async (employeeId: string, token: string): Promise<Employee> => {
    try {
      ...
      try {
        const response = await fetch(
          `${NEXT_PUBLIC_API_BASE_URL}/admin/users/${employeeId}`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
...
export const adminAPI = {
  ...
  getUserById: async (userId: string, token: string | null): Promise<User> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/users/${userId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getSystemSettings: async (token?: string): Promise<SystemSettings> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/settings`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getLicenses: async (token: string): Promise<License[]> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/licenses`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getUserGroups: async (
    ...
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/groups/user/${userId}/groups`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  getGroupMembers: async (groupName: string, token: string) => {
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/groups/${groupName}/members`,
      {
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
...
export const analyticsAPI = {
  getVisitorStats: async (token: string) => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/analytics/visitors`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getAccessMetrics: async (token: string): Promise<any> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/analytics/access`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getVisitorMetrics: async (token: string): Promise<any> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/analytics/visitor-metrics`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getTrainingMetrics: async (token: string): Promise<any> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/analytics/training`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
...
export const newVisitorAPI = {
  ...
  searchByEmail: async (email: string) => {
    try {
      const res = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/forms/email-lookup`,
        {
          method: "POST",
  ...
  checkInVisitor: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/visitors/${visitorId}/check-in`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  checkOutVisitor: async (id: string, token: string) => {
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/admin/visitors/${id}/checkout`,
      {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
  ...
  exportToExcel: async (token: string, filters: any) => {
    ...
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/visitors/export?${queryParams}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  validateQrCode: async (qrData: string) => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/validate-qr`,
        {
          method: "POST",
          body: JSON.stringify({ qrData }),
        }
  ...
  generateQrCode: async (visitorId: string) => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/qr/${visitorId}`,
        {
          method: "GET",
        }
      );
  ...
  getVisitorByEmail: async (email: string): Promise<string> => {
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/visitors/email/${email}`
    );
  ...
  getVisitorDocuments: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/documents/visitor/${visitorId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  getDocument: async (documentId: string, token: string): Promise<Document> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/documents/${documentId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  addDocument: async (visitorId: string, document: any) => {
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/admin/visitors/${visitorId}/documents`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
...
export const trainingAPI = {
  getAllTrainings: async () => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/trainings`
      );
      const data = await response.json();
      // console.log(data);
      return data;
  ...
  createTraining: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/admin/create-training`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  getTrainingById: async (trainingId: string): Promise<Training> => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/training/${trainingId}`,
        {
          method: "GET",
        }
      );
  ...
  submitTraining: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/training/submit`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  getTrainingStatus: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/training/enrollments/visitor/${visitorId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  markTrainingCompleted: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/forms/${id}/complete-training`,
        {
  ...
  getCompletedTrainingsByVisitor: async (contractorId: string) => {
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/forms/${contractorId}/completed-trainings`
      );
      const data = await response.json();
      console.log(data);
  ...
  enrollVisitor: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/training/enrollments`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  generateCertificate: async (
    ...
    try {
      const response = await fetch(
        `${NEXT_PUBLIC_API_BASE_URL}/training/certificates/${enrollmentId}`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  toggleTrainingStatus: async (trainingId: string, token: string | null) => {
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/training/${trainingId}/toggle`,
      {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${token}`,
...
export const hallAPI = {
  ...
  async fetchExternalGroups(hallName: string, token: string) {
    const res = await fetch(
      `${NEXT_PUBLIC_API_BASE_URL}/hall/${hallName}/groups`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
    ...
    const data = await res.json();
    if (!res.ok)
      throw new Error(data.message || "Failed to fetch external groups");
    return data.groups;
  },
};
